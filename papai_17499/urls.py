...
admin.site.site_header = "papai"
admin.site.site_title = "papai Admin Portal"
admin.site.index_title = "papai Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="papai API",
        default_version="v1",
        description="API documentation for papai App",
    ),
    public=True,
